...
declare namespace Cypress {
  interface Chainable {
     ...
     * Also includes a check to warn if any api request is not stubbed.
     * (Careful, it needs to be called before any other `cy.intercept` or it will throw false positive error)
     */
