        ...
        <Box bgcolor="grid.main" display="flex" flexDirection="column" justifyContent="flex-start" className="traderCard">
            <Box className="traderCardHeader" display="flex" flexDirection="row" alignItems="center">
                ...
                <Box className="traderCardHeaderTitleBox" display="flex" flexDirection="row" justifyContent="space-between" alignItems="center">
                    <Box className="nameBox" display="flex" flexDirection="column" justifyContent="space-between">
                        <Box display="flex" flexDirection="row" justifyContent="flex-start" alignItems="flex-start">
                            <Typography variant="h4" className="name">Ritoku Trendalyst</Typography>
                            <img src={ConnectedIcon} className="connectedIcon" alt="zignaly" />
                        </Box>
                        <Typography variant="caption" className="tradeType">Trades BTC</Typography>
                    </Box>
                    <Box className="commissionBox" display="flex" flexDirection="column" justifyContent="space-between" alignItems="flex-end">
            ...
            <Box className="traderCardBody">
                <Box className="returnsBox" display="flex" flexDirection="row" justifyContent="space-between" alignItems="center">
                    <Box className="returns" display="flex" flexDirection="column" justifyContent="space-between">
                        <Typography variant="h4" className="green">16%</Typography>
                        <Typography variant="subtitle1">returns(90D)</Typography>
                    </Box>
                    <Box className="openPositions" display="flex" flexDirection="column" justifyContent="space-between" alignItems="flex-end">
                        <Typography variant="h4" className="green">10%</Typography>
