  ...
  return (
    <ClickAwayListener onClickAway={() => setHover(false)}>
      ...
      >
        ...
        >
          <img
            src={darkStyle ? DashboardWhite : DashboardBlack}
            alt="zignaly"
            className={"icon"}
          />
        ...
        >
          <img
            src={darkStyle ? CopyWhite : CopyBlack}
            alt="zignaly"
            className={"icon"}
          />
        ...
        >
          <img
            src={darkStyle ? SignalWhite : SignalBlack}
            alt="zignaly"
            className={"icon"}
          />
        ...
        >
          <img
            src={darkStyle ? TerminalWhite : TerminlBlack}
            alt="zignaly"
            className={"icon"}
          />
