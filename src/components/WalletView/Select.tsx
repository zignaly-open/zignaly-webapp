...
const StyledSelect = styled(SelectMui)<{ customVariant: string }>`
  ${({ theme, fullWidth }) => css`
    background: ${theme.palette.mode === "dark" ? "#0C0D21" : "#ffffff"};
    color: ${theme.palette.mode === "dark" ? theme.newTheme.neutralText : "#0C0D21"};
    position: relative;
  ...
  ${({ theme, customVariant }) =>
    ...
    css`
      ...
      border-radius: 4px;
      border: none;
      color: ${theme.palette.mode === "dark" ? theme.newTheme.neutralText : "white"};
